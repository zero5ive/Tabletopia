                    ...
                    <div className="reservation-card">
                        ...
                        <div className={`reservation-content ${reservationType === 'reservation' ? 'active' : ''}`}>
                            ...
                            <div className="available-times">
                                ...
                                <div
                                    className={`time-slot ${selectedTime === '18:00' ? 'selected' : ''}`}
                                    onClick={() => handleTimeSlotClick('18:00')}
                                >
                                    18:00
                                </div>
                                <div
                                    className={`time-slot ${selectedTime === '19:00' ? 'selected' : ''}`}
                                    onClick={() => handleTimeSlotClick('19:00')}
                                >
                                    19:00
                                </div>
                                <div
                                    className={`time-slot ${selectedTime === '19:30' ? 'selected' : ''}`}
                                    onClick={() => handleTimeSlotClick('19:30')}
                                >
                                    19:30
                                </div>
                                <div
                                    className={`time-slot ${selectedTime === '20:00' ? 'selected' : ''}`}
                            ...
                            <button className="reservation-btn" onClick={handleReservation}>예약하기</button>
                        </div>
